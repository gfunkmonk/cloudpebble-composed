...
class RebbleOAuth2(BaseOAuth2):
    name = 'rebble'
    AUTHORIZATION_URL = '{0}/oauth/authorise'.format(settings.SOCIAL_AUTH_REBBLE_ROOT_URL)
    ACCESS_TOKEN_URL = '{0}/oauth/token'.format(settings.SOCIAL_AUTH_REBBLE_ROOT_URL)
    ...
    REBBLE_REDIRECT_URI = "http://cloudpebble.tk"
    ...
    def user_data(self, access_token, *args, **kwargs):
        url = '{0}/api/v1/me'.format(settings.SOCIAL_AUTH_REBBLE_ROOT_URL)
