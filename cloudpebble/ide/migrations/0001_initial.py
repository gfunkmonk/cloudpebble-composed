# -*- coding: utf-8 -*-
# Generated by Django 1.9.12 on 2019-10-19 18:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('theme', models.CharField(choices=[(b'cloudpebble', b'CloudPebble'), (b'monokai', b'Monokai (Sublime Text)'), (b'blackboard', b'Blackboard (TextMate)'), (b'eclipse', b'Eclipse'), (b'solarized light', b'Solarized (light)'), (b'solarized dark', b'Solarized (dark)')], default=b'solarized dark', max_length=50, verbose_name='Theme')),
                ('use_spaces', models.BooleanField(choices=[(True, 'Using spaces'), (False, 'Using tabs')], default=True, verbose_name='Indents')),
                ('tab_width', models.PositiveSmallIntegerField(default=4, verbose_name='Tab width')),
