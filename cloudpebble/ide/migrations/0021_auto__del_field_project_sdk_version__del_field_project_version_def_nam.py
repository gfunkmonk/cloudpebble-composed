...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Project.version_def_name'
        db.delete_column(u'ide_project', 'version_def_name')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Project.version_def_name'
        db.add_column(u'ide_project', 'version_def_name',
                      self.gf('django.db.models.fields.CharField')(default='APP_RESOURCES', max_length=50),
                      keep_default=False)
    ...
    models = {
        ...
        'ide.buildresult': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'644618ff-cf04-473a-a007-5304b6723265'", 'max_length': '36'})
        },
        'ide.project': {
            ...
            'app_uuid': ('django.db.models.fields.CharField', [], {'default': "'332ba902-ec95-4e95-ab40-555253c6c1b0'", 'max_length': '36', 'null': 'True', 'blank': 'True'}),
        ...
        'ide.usersettings': {
            ...
            'whats_new': ('django.db.models.fields.PositiveIntegerField', [], {'default': '6'})
        }
    }
