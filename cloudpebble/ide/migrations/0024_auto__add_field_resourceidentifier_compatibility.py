...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResourceIdentifier.compatibility'
        db.add_column(u'ide_resourceidentifier', 'compatibility',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResourceIdentifier.compatibility'
        db.delete_column(u'ide_resourceidentifier', 'compatibility')
    ...
    models = {
        ...
        'ide.buildresult': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'037a1ef6-cb3e-42bb-9e01-f63c0da77568'", 'max_length': '36'}),
        ...
        'ide.project': {
            ...
            'app_uuid': ('django.db.models.fields.CharField', [], {'default': "'4774002a-8fe0-4d57-941c-5aa41165a3d8'", 'max_length': '36', 'null': 'True', 'blank': 'True'}),
        ...
        'ide.usersettings': {
            ...
            'whats_new': ('django.db.models.fields.PositiveIntegerField', [], {'default': '14'})
        }
    }
