...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ide_buildsize', (
            ...
            ('build', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sizes', to=orm['ide.BuildResult'])),
            ('platform', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('total_size', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('binary_size', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('resource_size', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('worker_size', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('ide', ['BuildSize'])


    def backwards(self, orm):
        # Deleting model 'BuildSize'
        db.delete_table(u'ide_buildsize')
    ...
    models = {
        ...
        'ide.buildresult': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'00fb3623-ad83-4567-b43d-704ea175c70f'", 'max_length': '36'}),
        ...
        'ide.project': {
            ...
            'app_uuid': ('django.db.models.fields.CharField', [], {'default': "'30fcecad-a9d9-4079-9230-a17bec26fb1d'", 'max_length': '36', 'null': 'True', 'blank': 'True'}),
