...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BuildResult.worker_size'
        db.delete_column(u'ide_buildresult', 'worker_size')
    ...
    def backwards(self, orm):
        # Adding field 'BuildResult.worker_size'
        db.add_column(u'ide_buildresult', 'worker_size',
    ...
    models = {
        ...
        'ide.buildresult': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'577c91fc-68e0-49da-b856-2c6a06fcc7df'", 'max_length': '36'})
        },
        'ide.buildsize': {
        ...
        'ide.project': {
            ...
            'app_uuid': ('django.db.models.fields.CharField', [], {'default': "'125923a3-9a9b-4df6-ba1f-23562ff2801e'", 'max_length': '36', 'null': 'True', 'blank': 'True'}),
