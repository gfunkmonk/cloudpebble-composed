...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.app_platforms'
        db.add_column(u'ide_project', 'app_platforms',
    ...
    models = {
        ...
        'ide.buildresult': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'503c6890-7810-4ae5-8324-1dfcb89745cc'", 'max_length': '36'})
        },
        'ide.buildsize': {
        ...
        'ide.project': {
            ...
            'app_uuid': ('django.db.models.fields.CharField', [], {'default': "'2abdf81a-5b3c-40ab-a669-693a294437b3'", 'max_length': '36', 'null': 'True', 'blank': 'True'}),
