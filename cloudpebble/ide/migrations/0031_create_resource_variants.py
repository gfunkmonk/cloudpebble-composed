...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for resource in orm.ResourceFile.objects.all():
            variant = orm.ResourceVariant.objects.create(resource_file=resource, variant=0, is_legacy=True)

    def backwards(self, orm):
        "Write your backwards methods here."
        orm.ResourceVariant.objects.delete()
    ...
    models = {
        ...
        'ide.buildresult': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'3d2395b1-43b7-4d61-b301-ed833253c47c'", 'max_length': '36'})
        },
        'ide.buildsize': {
        ...
        'ide.project': {
            ...
            'app_uuid': ('django.db.models.fields.CharField', [], {'default': "'6104be45-a900-46cb-b96f-0b3bfa3e184e'", 'max_length': '36', 'null': 'True', 'blank': 'True'}),
