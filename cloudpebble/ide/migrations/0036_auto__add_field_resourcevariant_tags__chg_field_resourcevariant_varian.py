...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ResourceVariant.tags'
        db.add_column(u'ide_resourcevariant', 'tags',
    ...
    def backwards(self, orm):
        # Deleting field 'ResourceVariant.tags'
        db.delete_column(u'ide_resourcevariant', 'tags')
    ...
    models = {
        ...
        'ide.buildresult': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'7821f6a8-2ce7-4353-ac37-1edd988097eb'", 'max_length': '36'})
        },
        'ide.buildsize': {
        ...
        'ide.project': {
            ...
            'app_uuid': ('django.db.models.fields.CharField', [], {'default': "'5deffdbb-a5dd-45a2-978a-678e6e086a69'", 'max_length': '36', 'null': 'True', 'blank': 'True'}),
