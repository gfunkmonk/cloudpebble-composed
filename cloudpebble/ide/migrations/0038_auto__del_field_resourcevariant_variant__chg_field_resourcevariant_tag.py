...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ResourceVariant.variant'
        db.delete_column(u'ide_resourcevariant', 'variant')


        # Changing field 'ResourceVariant.tags'
        db.alter_column(u'ide_resourcevariant', 'tags', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default='', max_length=50))
        # Adding unique constraint on 'ResourceVariant', fields ['resource_file', 'tags']
        db.create_unique(u'ide_resourcevariant', ['resource_file_id', 'tags'])


    def backwards(self, orm):
        # Removing unique constraint on 'ResourceVariant', fields ['resource_file', 'tags']
        db.delete_unique(u'ide_resourcevariant', ['resource_file_id', 'tags'])

        # Adding field 'ResourceVariant.variant'
        db.add_column(u'ide_resourcevariant', 'variant',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


        # Changing field 'ResourceVariant.tags'
        db.alter_column(u'ide_resourcevariant', 'tags', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=50, null=True))
    ...
    models = {
        ...
        'ide.buildresult': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'f997deae-634f-4628-9106-f3e3e82902a3'", 'max_length': '36'})
        },
        'ide.buildsize': {
        ...
        'ide.project': {
            ...
            'app_uuid': ('django.db.models.fields.CharField', [], {'default': "'2e827396-06ef-44ab-b851-d3bcd8ebf2fb'", 'max_length': '36', 'null': 'True', 'blank': 'True'}),
        ...
        'ide.resourcevariant': {
            ...
            'tags': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '50'})
        },
        'ide.sourcefile': {
