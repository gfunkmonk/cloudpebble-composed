...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResourceIdentifier.target_platforms'
        db.add_column(u'ide_resourceidentifier', 'target_platforms',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=30, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResourceIdentifier.target_platforms'
        db.delete_column(u'ide_resourceidentifier', 'target_platforms')
    ...
    models = {
        ...
        'ide.buildresult': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'836953de-ebc1-4af1-a2a6-1378bf9ad883'", 'max_length': '36'})
        },
        'ide.buildsize': {
        ...
        'ide.project': {
            ...
            'app_uuid': ('django.db.models.fields.CharField', [], {'default': "'191723ea-64fa-4e4f-beb2-13a9ed69705b'", 'max_length': '36', 'null': 'True', 'blank': 'True'}),
