...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResourceIdentifier.memory_format'
        db.add_column(u'ide_resourceidentifier', 'memory_format',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ResourceIdentifier.storage_format'
        db.add_column(u'ide_resourceidentifier', 'storage_format',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ResourceIdentifier.space_optimisation'
        db.add_column(u'ide_resourceidentifier', 'space_optimisation',
                      self.gf('django.db.models.fields.CharField')(max_length=7, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResourceIdentifier.memory_format'
        db.delete_column(u'ide_resourceidentifier', 'memory_format')

        # Deleting field 'ResourceIdentifier.storage_format'
        db.delete_column(u'ide_resourceidentifier', 'storage_format')

        # Deleting field 'ResourceIdentifier.space_optimisation'
        db.delete_column(u'ide_resourceidentifier', 'space_optimisation')
    ...
    models = {
        ...
        'ide.buildresult': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'d9f95e19-62d6-4bdc-aa0f-22f41ae2cc88'", 'max_length': '36'})
        },
        'ide.buildsize': {
        ...
        'ide.project': {
            ...
            'app_uuid': ('django.db.models.fields.CharField', [], {'default': "'479b2c75-8eed-4463-963e-a5b0d01749ee'", 'max_length': '36', 'null': 'True', 'blank': 'True'}),
