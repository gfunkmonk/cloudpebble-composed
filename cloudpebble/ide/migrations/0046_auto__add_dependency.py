...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ide_dependency', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='dependencies', to=orm['ide.Project'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('version', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('ide', ['Dependency'])

        # Adding unique constraint on 'Dependency', fields ['project', 'name']
        db.create_unique(u'ide_dependency', ['project_id', 'name'])

        # Adding field 'Project.app_keywords'
        db.add_column(u'ide_project', 'app_keywords',
                      self.gf('django.db.models.fields.TextField')(default='[]'),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'Dependency', fields ['project', 'name']
        db.delete_unique(u'ide_dependency', ['project_id', 'name'])

        # Deleting model 'Dependency'
        db.delete_table(u'ide_dependency')

        # Deleting field 'Project.app_keywords'
        db.delete_column(u'ide_project', 'app_keywords')
    ...
    models = {
        ...
        'ide.buildresult': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'91bfe649-bbc6-404d-b9e2-5245b3ab41b9'", 'max_length': '36'})
        },
        'ide.buildsize': {
        ...
        'ide.project': {
            ...
            'app_uuid': ('django.db.models.fields.CharField', [], {'default': "'3d189e75-50d6-4e17-aa07-3ac28c399c3b'", 'max_length': '36', 'null': 'True', 'blank': 'True'}),
        ...
        'ide.usersettings': {
            ...
            'whats_new': ('django.db.models.fields.PositiveIntegerField', [], {'default': '21'})
        }
    }
